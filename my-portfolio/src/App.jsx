...
//               Design &amp; Creative Lead at Google Developer Groups On Campus, Bath Spa University UAE.
//             </p>
//             <div className="hero-contacts">
//               <a href="tel:0588874154" className="hero-contact-pill">📞 0588874154</a>
//               <a href="mailto:anaswara268@gmail.com" className="hero-contact-pill">✉️ anaswara268@gmail.com</a>
//             </div>
...
//                 <span className="badge green">ReactJS</span>
//                 <span className="badge purple">GDGOC Lead</span>
...
//               <p>Currently serving as the <strong>Design and Creative Lead</strong> for Google Developer Groups On Campus BSU RAK, where I lead visual storytelling and branding initiatives for the student community.</p>
//               <p>Gained practical industry experience through an internship at <strong>CodeLattice</strong>, building full-stack web applications and working on Zoho ecosystem integrations. Eager to leverage skills in digital design, creative problem-solving, and leadership to contribute to innovative projects.</p>
//             </div>
//           </div>
//         </div>
//       </section>
...
//                 <div className="sw-icon sw-ps" title="Photoshop">Ps</div>
//                 <div className="sw-icon sw-ai" title="Illustrator">Ai</div>
//                 <div className="sw-icon sw-fig" title="Figma">Fig</div>
//                 <div className="sw-icon sw-canva" title="Canva">Canva</div>
//               </div>
//               <div className="skill-pills">
//                 {["Photoshop","Illustrator","Figma","Canva"].map(s=><span key={s} className="skill-pill">{s}</span>)}
//               </div>
//             </div>
//             <div className="skill-category-card green-card reveal delay-2">
//               <div className="skill-cat-title green-title">Technical</div>
//               <div className="software-icons">
//                 <div className="sw-icon sw-react" title="ReactJS">React</div>
//                 <div className="sw-icon sw-mongo" title="MongoDB">Mongo</div>
//                 <div className="sw-icon sw-html" title="HTML">HTML</div>
//                 <div className="sw-icon sw-css" title="CSS">CSS</div>
//               </div>
//               <div className="skill-pills">
//                 {["ReactJS","MongoDB","HTML","CSS","UI/UX Principles","Zoho Ecosystem"].map(s=><span key={s} className="skill-pill green-pill">{s}</span>)}
//               </div>
//             </div>
...
//                 <div className="tl-role">Design and Creative Lead – Bath Spa University UAE</div>
//                 <div className="tl-date">2024 – Present</div>
//                 <ul>
//                   <li>Spearhead the creation of visual assets for campus events, workshops, and social media campaigns.</li>
//                   <li>Collaborate with cross-functional teams to ensure consistent branding and engaging user experiences for the student community.</li>
//                   <li>Mentor team members in design best practices and assist in organizing tech-focused events.</li>
//                 </ul>
//               </div>
//             </div>
//             <div className="timeline-item">
...
//                 <div className="tl-role green-role">Software Developer Intern – Dubai</div>
//                 <div className="tl-date">July 2025 – Sept 2025</div>
//                 <ul>
...
//               <div>
//                 <div className="edu-school">Bath Spa University UAE, Dubai</div>
...
//               <div className="edu-icon pink-icon">🏫</div>
//               <div>
...
//               <div className="project-thumb green-thumb">⚛️</div>
//               <div className="project-info">
//                 <div className="project-title">Full-Stack Web App</div>
//                 <div className="project-desc">Built a full-stack web application at CodeLattice using ReactJS for the frontend and MongoDB for backend data management.</div>
//                 <div className="project-tags">
...
//               <div className="project-thumb purple-thumb">🔗</div>
//               <div className="project-info">
...
//                 <a href="mailto:anaswara268@gmail.com" className="contact-pill">✉️ anaswara268@gmail.com</a>
//                 <a href="tel:0588874154" className="contact-pill">📞 0588874154</a>
...
//                       <input name="from_name" type="text" placeholder="Jane Doe" value={formState.name} onChange={e=>setFormState(p=>({...p,name:e.target.value}))} required />
//                     </div>
//                     <div className="form-group">
//                       <label>Email Address</label>
//                       <input name="reply_to" type="email" placeholder="jane@email.com" value={formState.email} onChange={e=>setFormState(p=>({...p,email:e.target.value}))} required />
//                     </div>
//                     <div className="form-group">
//                       <label>Message</label>
...
//         <p>Made with 💕 · <strong>Anaswara Anish</strong> · 2025</p>
...
// .hero-photo-inner { width:100%; height:100%; background:linear-gradient(135deg,#E8D5F5 0%,#C4A0D4 50%,#A0C4D4 100%); display:flex; align-items:center; justify-content:center; font-size:5rem; }
...
// .section-line { flex:1; height:3px; background:repeating-linear-gradient(90deg,var(--pink-dark) 0,var(--pink-dark) 8px,transparent 8px,transparent 14px); border-radius:2px; max-width:260px; }
// #about { background:var(--white); }
// .about-grid { display:grid; grid-template-columns:1fr 1.6fr; gap:3rem; align-items:center; }
...
// .about-avatar { width:110px; height:110px; border-radius:50%; background:linear-gradient(135deg,#E8D5F5,#A0C4D4); border:3px solid var(--white); display:flex; align-items:center; justify-content:center; font-size:2.5rem; margin:0 auto 1rem; box-shadow:4px 4px 0 var(--pink-dark); }
...
// .software-icons { display:flex; flex-wrap:wrap; gap:0.75rem; margin-bottom:0.75rem; }
// .sw-icon { width:52px; height:52px; border-radius:12px; display:flex; align-items:center; justify-content:center; font-size:0.6rem; font-weight:900; border:2px solid rgba(0,0,0,0.12); box-shadow:2px 2px 0 rgba(0,0,0,0.15); transition:transform 0.2s; cursor:default; color:#fff; text-transform:uppercase; }
// .sw-icon:hover { transform:translateY(-3px); }
// .sw-ps{background:#001C3D;border-color:#31A8FF;} .sw-ai{background:#330000;border-color:#FF9A00;} .sw-fig{background:#1E1E1E;border-color:#A259FF;} .sw-canva{background:#00C4CC;border-color:#00A8AE;font-size:0.5rem!important;} .sw-react{background:#20232A;border-color:#61DAFB;font-size:0.5rem!important;} .sw-mongo{background:#13AA52;border-color:#023430;font-size:0.48rem!important;} .sw-html{background:#E34F26;border-color:#F16529;font-size:0.56rem!important;} .sw-css{background:#1572B6;border-color:#33A9DC;font-size:0.58rem!important;}
...
// .project-thumb { height:160px; display:flex; align-items:center; justify-content:center; font-size:3rem; background:var(--pink); border-bottom:2px solid var(--pink-dark); }
